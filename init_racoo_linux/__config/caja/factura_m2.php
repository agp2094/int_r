...
class factura_m1 {
	...
	<?}?>
	<div class="pos_abs f3" style="top:191mm; left: 11mm; width: 200mm; height: 5mm; border-bottom: 1px dashed black;">
	...
	?>
		<div class="marco fondo_white pos_abs sombra" style="top:8mm; right: 11mm; width: 60mm; height: 73mm">
			<div style="text-align:center">
				<img src="<?=$_SESSION['limites']['archivos']['direccion_web']?>__config/logo.png" height="25mm"/>
			</div>
	...
	?>
	<div class="marco fondo_blanco pos_abs" style="top:135mm; right: 10mm; width: 30mm; height: 17mm">
	<table>	
		<tr>
	...
	<div class="marco fondo_gris pos_abs" style="top:135mm; right: 40mm; width: 20mm; height: 17mm">
	<table>	
		<tr>
	...
	<div class="marco pos_abs t_cen" style="top:155mm; right: 10mm; width: 50mm;">
		<img src="<?=$_SESSION['limites']['archivos']['direccion_web']?>apps/phpqrcode/miqr.php?data=re=<?=$Emisor['attr']['rfc']?>|rr=<?=$Receptor['attr']['rfc']?>|tt=<?=$Comprobante['attr']['total']?>|id=<?=$TimbreFiscalDigital['attr']['UUID']?>" height="35mm" width="35mm"/>
	</div>
	<?}?>
	...
	function v_addenda(  $top = 0 ){
		...
		<div class="pos_abs t_cen" style="top:<?=$top-12?>mm; left: 11mm; width: 738px; border-top: 1px solid #dfdfdf; font-size: 18px">
			<b>- - - DESGLOSE DE GASTOS ( PAGO POR CUENTA DE TERCEROS ) - - -</b> 
		</div>
		...
		<div class="marco fondo_blanco pos_abs f2" style="top:<?=$top+24?>mm; left: 52mm; width: 87mm; height: 5mm; padding-left:5mm">
			( <?=$this->o_tx->DoubleToLetra( number_format( floatval($Conceptos['attr']['importe'] ),2), "", " pesos" )?> M.N. )
		</div>
		<div class="marco fondo_gris pos_abs f2" style="top:<?=$top+24?>mm; left: 10mm; width: 43mm; height: 5mm">
		Cantidad con letra Cta.Ter.:		
		</div>
		<div class="marco fondo_blanco pos_abs t_rig" style="top:<?=$top+24?>mm; right: 10mm; width: 32mm; height: 5mm">
			<?=number_format( floatval($Conceptos['attr']['importe'] ),2)?>
		</div>
		<div class="marco fondo_gris pos_abs t_rig" style="top:<?=$top+24?>mm; right: 42mm; width: 25mm; height: 5mm">
			Total Cta.Ter.:
		</div>
		...
		if( isset($pago) ){
		?>
		<div class="marco fondo_blanco pos_abs t_rig" style="top:<?=$top+35?>mm; left: 35mm; width: 33mm; height:7mm;">
			$<?=number_format( floatval($pago['attr']['gtotal'] ),2)?>
		</div>
		<div class="marco fondo_gris pos_abs t_rig" style="top:<?=$top+35?>mm; left: 10mm; width: 26mm; height:7mm;">
			GRAN TOTAL:
		</div>
		<div class="marco fondo_blanco pos_abs t_rig" style="top:<?=$top+35?>mm; left: 94mm; width: 32mm; color: tomato; height:7mm;">
			-$<?=number_format( floatval($rps['attr']['importe'] ),2)?>
		</div>
		<div class="marco fondo_gris pos_abs t_rig" style="top:<?=$top+35?>mm; left: 72mm; width: 23mm; color: tomato; height:7mm;">
			ANTICIPOS:
		</div>
		<div class="marco fondo_blanco pos_abs t_rig" style="top:<?=$top+35?>mm; left: 161mm; width: 43mm; font-size: 20px;">
			<b>$<?=number_format( floatval($pago['attr']['neto'] ),2)?></b>
		</div>
		<div class="marco fondo_gris pos_abs t_rig" style="top:<?=$top+35?>mm; left: 130mm; width: 35mm; font-size: 20px">
			Neto a Pagar:
		</div>
		...
		?>
		<div class="marco fondo_blanco pos_abs t_cen" style=" top:<?=$top+45?>mm; right: 65mm; width: 140mm; height: 12mm; font-size: 14px">
			Neto a pagar: (<?=$this->o_tx->DoubleToLetra( mifloatval($pago['attr']['neto'],2), "", " pesos" )?> M.N. )
		</div>
		<div class="marco fondo_blanco pos_abs f3 t_cen" style="top:<?=$top+45?>mm; right: 10mm; width: 50mm; height: 12mm">
		<br>
